// BharatTechHelperRegistrar — thin utility that registers/unregisters the
// privileged helper daemon via SMAppService (macOS 13+) and reports status.
//
// Usage:
//   BharatTechHelperRegistrar --status     → {"status":"..."}
//   BharatTechHelperRegistrar --register   → {"status":"..."}
//   BharatTechHelperRegistrar --unregister → {"status":"..."}
//
...
private let plistName = "com.bharattech.app.helper.keepawake.plist"
